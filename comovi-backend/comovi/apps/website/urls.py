...
from comovi.apps.website.views import HomeView, LoginView, MyProfileView, InboxView, LogoutView, PropertyView, \
    ...
    InboxDetailView, EditUserProfileView
from comovi.apps.website.forms import NewUserProfileView
...
urlpatterns = [
    ...
    path('profiles/new/', NewUserProfileView.as_view(), name="new-user-profile"),
    path('edit/<uuid:pk>/', EditUserProfileView.as_view(), name="productupdate"),
